<!-- Home -->
    ...
    <script>
        var map = L.map('mapid').setView([-6.989399119972799, 110.42666361814848], 13);
        L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png', {
            maxZoom: 19,
            attribution: '&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>'
        }).addTo(map);
        L.marker([-6.989399119972799, 110.42666361814848]).addTo(map)
        .bindPopup("SMK 4 SMG").openPopup();
    </script>