	...
	<footer class="footer">
	    <div class="footer_background"
	        style="background-image:url(<?= base_url(); ?>template/front-end/images/footer_background.png)"></div>
	    <div class="container">
	                            ...
	                            <div class="footer_section footer_mobile">
	                                ...
	                                <div class="footer_mobile_content">
	                                    <div class="footer_image"><a href="#"><img
	                                                src="<?= base_url(); ?>template/front-end/images/mobile_1.png"
	                                                alt=""></a></div>
	                                    <div class="footer_image"><a href="#"><img
	                                                src="<?= base_url(); ?>template/front-end/images/mobile_2.png"
	                                                alt=""></a></div>
	                                </div>
	                            </div>
