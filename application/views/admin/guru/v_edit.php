    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <label for="">NIP</label>
                <input type="text" class="form-control" value="<?= $guru->nip; ?>" name="nip" placeholder="NIP" required>
            </div>
            <div class="form-group">
                <label for="">Nama Guru</label>
                <input type="text" class="form-control" value="<?= $guru->nama_guru; ?>" name="nama_guru" placeholder="Nama Guru" required>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="">Tempat Lahir</label>
                    <input type="text" class="form-control" value="<?= $guru->tempat_lahir; ?>" name="tempat_lahir" placeholder="Tempat Lahir" required>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="">Tanggal Lahir</label>
                    <input type="text" class="form-control" value="<?= $guru->tgl_lahir; ?>" name="tgl_lahir" id="tanggal" placeholder="Tanggal Lahir" required >
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
            ...
            <div class="form-group">
                <img src="<?= base_url('foto_guru/'.$guru->foto_guru); ?>" width="120px" alt="">
            </div>
            <div class="form-group">
